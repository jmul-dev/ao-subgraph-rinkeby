...
export class NameFactory__getNameResult {
	value0: string;
	value1: Address;
	value2: string;
	value3: string;
	...
	constructor(value0: string, value1: Address, value2: string, value3: string, value4: string, value5: Bytes, value6: i32) {
		this.value0 = value0;
		this.value1 = value1;
		this.value2 = value2;
		this.value3 = value3;
...
export class NameFactory extends SmartContract {
	static bind(address: Address): NameFactory {
		return new NameFactory("NameFactory", address);
	}
	...
	setNameNewAddress(_id: Address, _newAddress: Address): boolean {
		let result = super.call("setNameNewAddress", [EthereumValue.fromAddress(_id), EthereumValue.fromAddress(_newAddress)]);
		return result[0].toBoolean();
	}
	...
	incrementNonce(_nameId: Address): BigInt {
		let result = super.call("incrementNonce", [EthereumValue.fromAddress(_nameId)]);
		return result[0].toBigInt();
	}

	ethAddressToNameId(_ethAddress: Address): Address {
		let result = super.call("ethAddressToNameId", [EthereumValue.fromAddress(_ethAddress)]);
		return result[0].toAddress();
	}

	nameIdToEthAddress(_nameId: Address): Address {
		let result = super.call("nameIdToEthAddress", [EthereumValue.fromAddress(_nameId)]);
		return result[0].toAddress();
	}

	getName(_nameId: Address): NameFactory__getNameResult {
		let result = super.call("getName", [EthereumValue.fromAddress(_nameId)]);
		return new NameFactory__getNameResult(
			result[0].toString(),
			result[1].toAddress(),
			result[2].toString(),
			result[3].toString(),
	...
	getNameIds(_from: BigInt, _to: BigInt): Array<Address> {
		let result = super.call("getNameIds", [EthereumValue.fromUnsignedBigInt(_from), EthereumValue.fromUnsignedBigInt(_to)]);
